/*
Stochastic LRBroyden LR-SBroyden-VR
 
Solvers --> SolversSM --> SolversSMSto --> SolversSMSVRG --> SVRLRBroydenFamily
 
by Shuguang Zhang, modified by Wen Huang
 */

#ifndef SVRLRBROYDENFAMILY_H
#define SVRLRBROYDENFAMILY_H
...
namespace roptlite{
    ...
    public:
        /*The contructor of LRBroyden method. It calls the function Solvers::Initialization.
         INPUT : prob is the problem which defines the cost function, gradient and possible the action of Hessian
         and specifies the manifold of domain.
         initialx is the initial iterate.
         insoln is the true solution. It is not required and only used for research*/
        SVRLRBroydenFamily(const Problem *prob, const Variable *initialx);
        
        /*Destructor. Delete the arrays and vectors used in LRBroyden, i.e., series S and Y, and series RHO*/
        virtual ~SVRLRBroydenFamily(void);
        
        /*Check whether the parameters about LRBroyden are legal or not.*/
        ...
        // phiset controls the delta in Hybrid Davidon-BFGS strategy
        realdp phiset;
    ...
    protected:
        ...
        /*Print information specific to LRBroyden*/
        virtual void PrintInfo(void);
        
        /*Compute result = H v*/
        virtual Vector &HvSVRLRBroydenFamily(const Vector &v, Vector *result);
        ...
        /*Update the Hessian approximation for LRBroyden if necessary*/
        virtual void UpdateDataSVRLRBroydenFamily(void);
        
        /*Call Solvers::SetProbX function and set up the temporary objects for LRBroyden algorithm.
         INPUT:    prob is the problem which defines the cost function, gradient and possible the action of Hessian
         and specifies the manifold of domain.
         initialx is the initial iterate.*/
