/*
 Stochastic LRBFGS: LR-SBFGS-VR
 
 Solvers --> SolversSM --> SolversSMSto --> SolversSMSVRG --> SVRLRBFGS
...
namespace roptlite{
    ...
    protected:
        ...
        virtual Vector &HvSVRLRBFGS(const Vector &v, Vector *result);
        ...
        virtual void UpdateDataSVRLRBFGS(void);
