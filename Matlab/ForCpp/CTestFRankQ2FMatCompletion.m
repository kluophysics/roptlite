...
%     seed = 26052;
    seed = 1;
    fprintf('CTestFRankQ2FMatCompletion seed:%d\n', seed);
    rng(seed);
    m = 200;
    n = 200;
    r = 4;
...
%     SolverParams.InitSteptype = 0;
    HasHHR = 0;
    ParamSet = 1;
    [Xopt, f, gf, gfgf0, iter, nf, ng, nR, nV, nVp, nH, ComTime, funs, grads, times, Heigs] = TestFRankQ2FMatCompletion(A, Xinitial, r, HasHHR, ParamSet, SolverParams);
%     Heigs
% end
